...
| `davis-lawn/` | Second client: **Davis Lawn Service & Hauling** — conversion-first landing (pure CSS/SVG, no AI images) + `BRIEF.md`, the reusable client-site prompt/template |
